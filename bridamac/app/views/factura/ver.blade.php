...
<div  class="col-xs-2"> <button  type="button" class="btn btn-primary btn-lg" data-toggle="modal" onclick="printCanvas()" data-target="#create_product">Imprimir&nbsp;&nbsp;</button> </div>
<div  class="col-xs-2"> <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" onclick="descargarPDF()" data-target="#create_service">Descargar PDF</button> </div>
<div class="col-xs-4"></div>
<br><br><br><br>
